...
exports["default"] = function (md) {
    var ciClone = md.renderer.rules.code_inline.bind(md.renderer.rules);
    var feClone = md.renderer.rules.fence.bind(md.renderer.rules);

    // Inline math:
    md.renderer.rules.code_inline = function (tokens, idx, options, env, slf) {
        tokens[idx].content = (0, _asciimath2["default"])(tokens[idx].content);
        tokens[idx].content = (0, _katex2["default"])(tokens[idx].content);
    ...
    md.renderer.rules.fence = function (tokens, idx, options, env, slf) {
        if (tokens[idx].info === "katex") {
            return (0, _katex4["default"])(tokens[idx].content);
        }

        if (tokens[idx].info === "math") {
            return (0, _katex4["default"])((0, _asciimath2["default"])(tokens[idx].content, true));
        }
...
var _asciimath = __webpack_require__(2);

var _asciimath2 = _interopRequireDefault(_asciimath);

var _katex = __webpack_require__(4);

var _katex2 = _interopRequireDefault(_katex);

var _katex3 = __webpack_require__(5);

var _katex4 = _interopRequireDefault(_katex3);
...
exports["default"] = function (code) {
    ...
    if (code.startsWith("math")) {
        return "katex " + String((0, _asciimathToLatex2["default"])(code.substr(4, code.length - 2)));
    }

    if (force) {
        return "katex " + String((0, _asciimathToLatex2["default"])(code));
    }

    return code;
};

var _asciimathToLatex = __webpack_require__(3);
...
var _katex = __webpack_require__(0);
...
function renderToString(code) {
    try {
        ...
        return "<code class=\"maths-formula-error\">" + String(err) + "</code>";
    }
}
...
exports["default"] = function (code) {
    ...
    code.trim().split(/(?:\n\s*){2,}/).forEach(function (line) {
        try {
            text += _katex2["default"].renderToString(line.trim(), { displayMode: true });
        } catch (err) {
            text += "<pre class=\"maths-formula-error\">" + String(err) + "</pre>";
        }
    });

    return "<div class=\"maths-formula\">" + String(text) + "</div>";
};
